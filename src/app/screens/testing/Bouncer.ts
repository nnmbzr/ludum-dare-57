...
import type { TestingScreen } from './TestingScreen';
...
export class Bouncer {
  ...
  public async show(screen: TestingScreen): Promise<void> {
    this.screen = screen;
  ...
  public remove(): void {
    ...
    if (logo) {
      gsap
        .to(logo, { alpha: 0, duration: Bouncer.ANIMATION_DURATION })
        .then(() => {
